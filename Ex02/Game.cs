...
namespace Logic
{
    class Game
    {
        ...
        public void GetComputerChoise(Player i_Player, object i_FirstCardValue, out int o_Row,out int o_Column)
        {
            (int, int) knownCard;

            if (i_FirstCardValue.Equals(k_FirstTimeValue)) 
            {
        ...
        {
            bool isEqualCardsValues = i_FirstCard.Value.Equals(i_SecondCard.Value);
